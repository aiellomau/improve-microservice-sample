...
import com.improve.reservations.configserver.ConfigApplication;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes = ConfigApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
